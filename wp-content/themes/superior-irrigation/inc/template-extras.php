 ...
 */
function heritage_categorized_blog() {
	$category_count = get_transient( 'heritage_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'heritage_categories', $category_count );
	}
 ...
 */
function heritage_get_attachment_id_from_url( $attachment_url = '' ) {
	global $wpdb;
 ...
 */
function heritage_copyright_year( $atts ) {
	// Setup defaults.
	$args = shortcode_atts(
		[
			'starting_year' => '',
...
add_shortcode( 'heritage_copyright_year', 'heritage_copyright_year' );
 ...
 */
function heritage_get_custom_logo_url() {
