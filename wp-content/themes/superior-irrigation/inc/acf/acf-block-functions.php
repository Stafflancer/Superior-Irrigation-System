...
function heritage_display_block_button($button)
{
	...
	// Print our block container with options.
	printf('<div class="wp-block-button"><a href="%s" class="wp-block-button__link btn %s">%s</a></div>', esc_url($button['button']['url']), esc_attr($buttonClass), esc_attr($button['button']['title']));
}
...
function heritage_get_theme_colors()
{
	return [
		...
		esc_html__('Heritage Gold', 'heritage') => '#eaaa00',
