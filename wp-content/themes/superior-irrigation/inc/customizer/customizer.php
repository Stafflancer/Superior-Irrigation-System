 ...
 */
function heritage_remove_default_customizer_sections( $wp_customize ) {
	// Remove sections.
...
add_action( 'customize_register', 'heritage_remove_default_customizer_sections', 15 );
 ...
 */
function heritage_include_custom_controls() {
...
add_action( 'customize_register', 'heritage_include_custom_controls', -999 );
 ...
 * @author WebDevStudios
 */
function heritage_customize_scripts() {
	wp_enqueue_script( 'heritage-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
add_action( 'customize_preview_init', 'heritage_customize_scripts' );
 ...
 */
function heritage_selective_refresh_support( $wp_customize ) {
	// The <div> classname to append edit icon too.
	$settings = [
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'heritage_copyright_text' => '.site-info',
	];
...
add_action( 'customize_register', 'heritage_selective_refresh_support' );
 ...
 */
function heritage_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'heritage_live_preview_support', 999 );
