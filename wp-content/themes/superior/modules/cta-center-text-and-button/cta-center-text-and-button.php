<?php
wp_enqueue_style('cta-center-text-and-button-styles', get_template_directory_uri() . '/static/css/modules/cta-center-text-and-button/cta-center-text-and-button.css', '', '', 'all');
...
$id = 'cta-center-text-and-button-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className".
$sectionClassName = 'cta-center-text-and-button';
        ...
        <?php } 
         ...
         if ($button) { ?>
            <div class="form-holder">
                 <a href="<?php echo $button['url']; ?>" class="cta-center-btn has-background btn-heritage-gold btn-" target="<?php echo $button['target']; ?>"><?php echo $button['title']; ?></a>
            </div>
        <?php } ?>
    </div>
