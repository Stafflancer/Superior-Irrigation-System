...
if (!empty($gallery)) {
    ...
    wp_enqueue_script('single-store-info-js', get_template_directory_uri() . '/static/js/modules/single-store-info/single-store-info.js', '', $version, true);
}
    ...
    <div class="container">
        <div class="cols">
            <div class="info-col">
                ...
                <a href="<?php echo get_the_permalink(104) ?>" class="custom-btn btn-theme-yellow">
