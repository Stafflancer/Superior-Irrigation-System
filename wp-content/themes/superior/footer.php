    ...
    <div class="container wide">
        <div class="section-wrapper">
            ...
            <div class="bottom-holder">
                ...
                if (!empty($copyright_text) || !empty($social_media)) { ?>
                ...
                $member_logo = get_field('member_logo', 'option');
                $member_logo_link = get_field('member_logo_link', 'option');
                if($member_logo)
                { ?>
                    <div class="member-logo">
                        <a href="<?php echo $member_logo_link; ?>" class="h-logo" target="_blank">
                            <?php echo wp_get_attachment_image($member_logo, 'm_logo'); ?>      
                        </a>
                    </div><?php
                } ?>
            </div>
